...
//        recyclerView.setItemAnimator(new DefaultItemAnimator());
        ...
        getSupportActionBar().setTitle("Find your Fit");

        if (icicle != null)
            cameraId = icicle.getInt(BUNDLE_CAMERA_ID, 1);

        ImageButton btnR1 = (ImageButton) findViewById(R.id.btn_R1);
        btnR1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mFaceView.which_glass_string = R.drawable.glass10;
            }
        });
        ImageButton btnR2 = (ImageButton) findViewById(R.id.btn_R2);
        btnR2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mFaceView.which_glass_string = R.drawable.glass11;
            }
        });
        ImageButton btnR3 = (ImageButton) findViewById(R.id.btn_R3);
        btnR3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mFaceView.which_glass_string = R.drawable.glass13;
            }
        });
...
//            Log.i("FaceDetectThread", "running");
            ...
            for (int i = 0; i < MAX_FACE; i++) {
                if (fullResults[i] == null) {
                    ...
                    float pose_x = fullResults[i].pose(android.media.FaceDetector.Face.EULER_X);
                    float pose_y = fullResults[i].pose(android.media.FaceDetector.Face.EULER_Y);
                    float pose_z = fullResults[i].pose(android.media.FaceDetector.Face.EULER_Z);
                    ...
                    if(rect.height() * rect.width() > 100 * 100) {
                        ...
                        faces[i].setFace(idFace, mid, eyesDis, confidence, pose_x, pose_y, pose_z, System.currentTimeMillis());

                        faces_previous[i].set(faces[i].getId(), faces[i].getMidEye(), faces[i].eyesDistance(), faces[i].getConfidence(), faces[i].getPoseX(),faces[i].getPoseY(),faces[i].getPoseZ(), faces[i].getTime());
